 ...
 */
public class IdentifyX extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, Object> map = getIdentifyChinese(1);
        String random = (String) map.get("identifyString");
        BufferedImage bi = (BufferedImage) map.get("identifyImage");
        //将随机汉字存在session域-将图形写给浏览器-发头控制浏览器不要缓存
     ...
     * 提供验证码
     * @param type(1中文2英文)
     * @return 存放验证码图和文字的map
     */
    public HashMap<String, Object> getIdentifyChinese(int type){
        //创建缓存-获得画布-设置背影-设置边框-画干扰线-写随机数
        BufferedImage bi = new BufferedImage(WIDTH, HEIGHT,BufferedImage.TYPE_INT_RGB); 
        Graphics graphics = bi.getGraphics(); 
        setBackGround(graphics);
        setBorder(graphics);
        drawRandomLine(graphics);
        String random = drawRandomNum((Graphics2D) graphics , type);
        HashMap<String, Object> map = new HashMap<String, Object>();
        map.put("identifyImage", bi);
        map.put("identifyString", random);
        return map;
    }
    
    /**
     * 设置背景
     * @param graphics 待处理的图像
     */
     ...
     * @return 验证码字符串
     */
    private String drawRandomNum(Graphics2D graphics , int type){
